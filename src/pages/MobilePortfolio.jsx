...
import { Card, ImageComp, Sidebar, ScrollTo, Topbar, useDarkMode } from '../components';
    ...
    <div className={`mobile-portfolio ${darkMode ? '' : 'dark'}`}>
      ...
      <div className='main-col'>
          ...
          <div id='prof-table-mobile'>
            <div className='col-mob'>
              ...
              <div className='row-mob'>
                ...
                <div className='col-mob'>
                  <p className='skills'>Javascript<br />TypeScript<br />Liquid<br />JSON</p>
                </div>
                <div className='col-mob'>
        ...
        <section>
          ...
          <div style={{ paddingTop: '2vh', borderTop: '1px solid #216E4E' }} />
          <div className='project-link'>
