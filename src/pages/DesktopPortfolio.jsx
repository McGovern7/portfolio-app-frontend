		...
		<div className={`desktop-portfolio  ${darkMode ? '' : 'dark'}`}>
			...
			<div className={`left-col ${leftStatus ? '' : 'hidden-a'} ${rightStatus ? '' : 'hidden-b'}`}>
				<section>
					...
					<h1 style={{ paddingTop: "14px" }}>LUKE MCGOVERN</h1>
			...
			<div className={`right-col ${leftStatus ? '' : 'hidden-a'} ${rightStatus ? '' : 'hidden-b'}`}>
				<section id='about-me'>
					<h2 style={{ paddingTop: "33px", marginBottom: "0" }}>ABOUT ME</h2>
					...
					<p className='mb-0'>
						...
						<ScrollTo className='scroll-link text-primary' content=' More info' embed='True' sectionID='work-experience' /><br /><br />
					...
					<div id='prof-table'>
						...
						<div className='col tools'>
							...
							<div className='row'>
								...
								<div className='col skills'>
									<p>React.js<br />Node.js<br />Data Privacy<br />WordPress<br />Site Hosting</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section id='work-experience'>
                  ...
                  <img alt="Wordpress content management system" src="https://img.shields.io/badge/-CMS-_?logo=wordpress&label=WordPress&color=%2321759B" />
					...
					<Card className='inactive-job'
						title={<p className='card-title'><b>TECH CONSULTANT<br /> 
						<Link className='card-link' aria-label="Open Donahue & Associates website in a new tab" to='https://www.donahueassociatesvt.com/' target="_blank" rel="noopener noreferrer">
							Donahue & Associates<FiArrowUpRight className='external' />
						</Link>
						</b> 5/23-8/23</p>}
						content={<ul className='card-content'>
