    ...
    <body className='main-page'>
      ...
      <main>
        ...
        <section className='dataflow'>
          ...
          <ImageComp ariaLabel='api data diagram' src='DataFlow.webp' className='data-flow-img' alt="Flow Diagram of how data transfers from frontend to backend using software packages" />
          <div className='image-set'>
            <ImageComp ariaLabel='Logged out flowchart' src='LoggedOut.webp' className='logged-out-img' alt="Chart depicting a logged out user's API call Dataflow" />
            <ImageComp ariaLabel='Logged in flowchart' src='LoggedIn.webp' className='logged-in-img' alt="Chart depicting a logged In user's API call Dataflow" />
          </div>
        </section>
      </main>
    </body >
